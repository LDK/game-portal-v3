...
const Footer = () => (
  <Box className="z-50 text-center backdrop-blur-xl p-4 fixed w-full bottom-0 left-0 align-items-middle text-sm mt-4 h-[72px] bg-blend-color-burn text-yellow-100/90 bg-emerald-900/90">
